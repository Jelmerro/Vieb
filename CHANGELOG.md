...
- Command "translatepage" to translate the page using the Deepl API
- Settings "translatekey", "translatelang" and "translateurl" to customize translation settings for ":translatepage"
